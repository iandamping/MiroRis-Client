...
sealed class MultiAdapterProductManagementOnGoingData {
    data class Shimmer(val epoxyId: Int) : MultiAdapterProductManagementOnGoingData()

    data class ProductOnGoing(
        val epoxyId: Int,
    ...
    ) : MultiAdapterProductManagementOnGoingData()

    object Error : MultiAdapterProductManagementOnGoingData()
}