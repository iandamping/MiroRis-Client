...
class RemoteProfileDataSourceImplTest {

    private lateinit var sut: RemoteProfileDataSource
...
//
//    @Test
//    fun `when datasource call getProfile should return Success`() = runTest {
//        //given
//        val profileResponse =
//            ProfileResponse("a", "a", "a", "a", "a")
//        val successResponse = ProfileRemoteResult.Success(profileResponse)
//        coEvery {
...
//        )
//        //when
//        val actualResult = sut.getProfile("a", "a")
//        coVerify(
//            exactly = 1,
//            verifyBlock = {
//                remoteHelper.nonEncryptionCall(
...
//                )
//            })
//        coVerify(exactly = 1, verifyBlock = { apiInterface.getProfile(any(), any(), any()) })
...
//
//    @Test
//    fun `when datasource call getProfile should return Error from code 201`() = runTest {
//        //given
//        val profileResponse =
//            ProfileResponse("a", "a", "a", "a", "a")
//        val successResponse = ProfileRemoteResult.Error("Failed")
//        coEvery {
//            remoteHelper.nonEncryptionCall(
//                apiInterface.getProfile(
//                    any(),
...
//    }
    ...
    @Test
    fun `when datasource call getProfile should return Error from null body`() = runTest {
        //given
        val successResponse = ProfileRemoteResult.Error("response body is null")
        coEvery {
            remoteHelper.nonEncryptionCall(
                apiInterface.getProfile(
                    any(),
    ...
    @Test
    fun `when datasource call getProfile should return Error from null data`() = runTest {
        //given
        val successResponse = ProfileRemoteResult.Error("data from service is null")
        coEvery {
            remoteHelper.nonEncryptionCall(
                apiInterface.getProfile(
                    any(),
    ...
    @Test
    fun `when datasource call getProfile should return Error from catching exception`() = runTest {
        //given
        coEvery {
            apiInterface.getProfile(
                any(),
        ...
        //then
        assertEquals(
            "Error", (actualResult as ProfileRemoteResult.Error).errorMessage
        )
    }
